...
def Carre():
    ...
    Xc = randrange(0,250)
    Yc = randrange(0,250)
    Canevas.create_rectangle(Xc,Yc,Xc + TAILLE,Yc + TAILLE,fill="green",tag='rectangle')
...
def Disque():
    ...
    if no_couleur.get()==1:
        Xd = randrange(0,250)
        Yd = randrange(0,250)
        Canevas.create_oval(Xd,Yd,Xd + TAILLE,Yd + TAILLE,fill="red",tag='disque')
        label_3["text"]="Rouge"
    else:
        Xd = randrange(0,250)
        Yd = randrange(0,250)
        Canevas.create_oval(Xd,Yd,Xd + TAILLE,Yd + TAILLE,fill="blue",tag='disque')
        label_3["text"]="Bleu"

def Reset():

    Canevas.delete('disque','rectangle')
    Xv=100
    Yv=250
    Canevas.coords(vaisseau,Xv,Yv)
...
bouton_disque = Button(fenetre,text = " Disque ",bg= 'blue' ,command = Disque)
bouton_reset = Button(fenetre,text = " Reset",bg= 'yellow',command = Reset)
...
bouton_disque.pack(side = LEFT,padx = 10,pady = 10)
